...
int kretprobe__tcp_sendmsg(struct pt_regs *ctx) {
    ...
    // TODO: change to real protocol
    return handle_message(&t, sent, 0, CONN_DIRECTION_UNKNOWN, packets_out, packets_in, PACKET_COUNT_ABSOLUTE, PROTOCOL_UNKNOWN, skp);
}
...
int kprobe__tcp_cleanup_rbuf(struct pt_regs *ctx) {
    ...
    return handle_message(&t, 0, copied, CONN_DIRECTION_UNKNOWN, 0, 0, PACKET_COUNT_NONE, PROTOCOL_UNKNOWN, sk);
}
